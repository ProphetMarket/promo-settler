...
This repository holds only the contract. The funding model, the per-trade cap, and the exact function set are open design questions, worked out in a separate design exploration before any code is written.
